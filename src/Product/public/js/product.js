// Function Handle
function render() {
  const html = itemProduct.map((element, index) => {
    return `
    <div>
  ...
  document.querySelector(".featured-owl-carousel").innerHTML = html.join("");

  const htmls = itemProduct.map((element) => {
    return `
      <div class="item">
        <div class="more-product__item">
            <div class="more-product__img">
                <img src="img/sp1-10/${element.name}.jpg" alt="">
                <span class="sale-label">Sale</span>
                <div class="more-product__content">
                    <p class="more-product__name">
                        ${element.description}
                    </p>
                    <div class="more-price">
                        <span class="more-product__price">$${element.cost}</span>
                        <span class="more-product__oldprice">$${element.costOld}</span>
                    </div>
                </div>
            </div>
        </div>
  ...
  document.querySelector(".more-owl-carousel").innerHTML = htmls.join("");
}
